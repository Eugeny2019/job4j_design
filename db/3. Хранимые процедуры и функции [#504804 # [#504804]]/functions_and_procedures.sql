...
alter procedure update(u_count integer, tax float, u_id integer) rename to update_data;
...
call insert_data('product_2', 'producer_2', 15, 32);
call insert_data('product_1', 'producer_2', 0, 32);
call insert_data('product_3', 'producer_1', 45, 200);
select * from products;

create or replace procedure delete_from_products_if_count_id_0()
language 'plpgsql'
as $$
    BEGIN
    delete
...
call delete_from_products_if_count_id_0();
select * from products;
